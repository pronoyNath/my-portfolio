...
const Interests = () => {
    return (
        <section className=" text-gray-100 mt-10 pb-10">

            <div className="container p-6 mx-auto space-y-6 text-center lg:p-8 lg:space-y-8" >
                <h2 className="text-3xl font-bold text-white">Technologies I have worked with</h2>
                <div className="flex flex-wrap justify-center lg:justify-between pt-5 marquee" >
                    ...
                    {/* <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Vue.js" className="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 text-gray-400">
                        <title>Vue.js</title>
