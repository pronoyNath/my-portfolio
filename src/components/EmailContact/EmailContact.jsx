            ...
            <div className="grid max-w-screen-xl grid-cols-1 gap-12 px-8 pt-10 pb-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32" >
                ...
                <div className="flex flex-col items-center justify-between" >
                    <div className="space-y-2" >
                        ...
                        <div className="text-gray-400" >What are you thinking? just say it.</div>
                    </div>
                ...
                <form ref={form} onSubmit={sendEmail} className="space-y-6 ">
                    <div >
                        ...
                        <input id="name" type="text" name="user_name" placeholder="" className="w-full p-3 rounded bg-gray-800" required />
                    </div>
                    <div >
                    ...
                    <div >
                        ...
                        <input id="company" name="user_company" type="text" className="w-full p-3 rounded bg-gray-800" required />
                    </div>
                    <div >
                        <label className="text-sm">Message</label>
                        <textarea name="message" id="message" rows="3" className="w-full p-3 rounded bg-gray-800" required></textarea>
                    </div>
                    <button type="submit" className="w-full p-3 text-sm font-bold tracki uppercase rounded hover:bg-[#c49037] bg-[#dbb878] text-gray-900">Send Message</button>
                </form>
            </div>
        </div>
    );
