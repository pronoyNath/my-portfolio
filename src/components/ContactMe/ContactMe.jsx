...
const ContactMe = () => {
    return (
        <div id="contact" className="dark:bg-[#1c264f] dark:text-gray-50 ">
            <footer className="max-w-6xl mx-auto py-10">
                ...
                <p className="text-xl lg:text-2xl ml-2 font-semibold flex gap-2 lg:gap-5">Feel free to reach out!
                <IoPaperPlaneSharp  className="text-5xl lg:text-6xl"/></p>
                </div>
                <div className="text-2xl lg:text-4xl space-y-5 mt-10 lg:mt-0">
